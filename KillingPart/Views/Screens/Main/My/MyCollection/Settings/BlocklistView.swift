...
struct BlocklistView: View {
    ...
    var body: some View {
        ...
        .sheet(item: $pendingUnblockUser) { user in
            BlocklistUnblockConfirmSheet(
                user: user,
                isUnblockingUser: viewModel.isUnblockingUser,
                errorMessage: viewModel.unblockErrorMessage,
                onCancel: {
...
private struct BlocklistUnblockConfirmSheet: View {
    let user: UserModel
    let isUnblockingUser: Bool
    ...
    var body: some View {
        ...
        .interactiveDismissDisabled(isUnblockingUser)
